...
NNavy = {
	...
	MISSION_FUEL_COSTS = {  -- fuel cost for each mission
		...
		0.8, -- PATROL
		0.8, -- STRIKE FORCE (does not cost fuel at base, and uses IN_COMBAT_FUEL_COST in combat. this is just for the movement in between)
		0.8, -- CONVOY RAIDING
		0.8, -- CONVOY ESCORT
		0.8, -- MINES PLANTING
		0.8, -- MINES SWEEPING
		...
		0.8, -- NAVAL_INVASION_SUPPORT (does not cost fuel at base, only costs while doing bombardment and escorting units)
	},
